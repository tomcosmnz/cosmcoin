...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cosmcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cosmcoin.cc", "dns.cosmcoin.cc"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"cosmcointools.com", "testnet-seed.cosmcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cosmcoin is probably already running."), addrBind.ToString().c_str());
        else
